...
<body>
	...
	<form action="" method="post" enctype="multipart/form-data">
		...
		<div class="container">
			...
			<input type="text" placeholder="Enter Product Name" id="productname" name="product_name" required>
			
			<label for="productprice"><b>Price</b></label>
			<input type="number" placeholder="Enter Product Name" id="productprice" name="product_price" required>
